  ...
  <body style="padding: 0;margin: 0;;">
    ...
    <nav class="flex items-center justify-between bg-white p-4 shadow-md">
      ...
      <ul class="flex">
        ...
        <li><a href="cart.jsp" class="mx-4 text-gray-600 hover:text-gray-800" style="font-family: cursive;">MyCart<span class="badge badge-danger">${ cart_list.size()}</span></a></li>
      </ul>
        ...
        <% if(user !=null) { %>
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="javascript:void(0)">Update Profile</a>
    ...
    <section class="py-12 px-4">
      ...
      <section class="py-12 px-4">
          ...
          <div class="-mx-4 flex flex-wrap">
            ...
            <div class="mb-8 w-full px-4 md:w-1/4">
              <div class="overflow-hidden rounded-lg bg-white shadow-md cart-img" >
                ...
                <div class="p-4">
                  <h3 class="mb-2 text-2xl font-bold">Bruton Shoes</h3>
                  <p class="text-gray-700">392 INR</p>
                  <a href="addcart.do?id=7&name=Bruton Shoes&price=392&category=shoes"><button class="mt-4 rounded bg-blue-500 py-2 px-4 font-bold text-white hover:bg-blue-700">Add to
                    Cart</button></a>
                </div>
              </div>
            </div>
            <div class="mb-8 w-full px-4 md:w-1/4">
              <div class="overflow-hidden rounded-lg bg-white shadow-md cart-img"  >
                ...
                <div class="p-4">
                  <h3 class="mb-2 text-2xl font-bold">Asian's Men Shoes</h3>
                  <p class="text-gray-700">524 INR</p>
                  <a href="addcart.do?id=8&name=Asian's Men Shoes&price=524&category=shoes"><button class="mt-4 rounded bg-blue-500 py-2 px-4 font-bold text-white hover:bg-blue-700">Add to
                    Cart</button></a>
                </div>
              </div>
            </div>
        ...
        <section class="py-12 px-4">
          ...
          <form action="https://formsubmit.co/omsingrore2002@gmail.com" method="post" style="margin-top: 10vh; margin-bottom: 10vh;">
